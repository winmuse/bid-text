     ...
     <div class="theiaStickySidebar">
      <div class="box-grey rounded  relative">
        ...
        <?php
        	...
        	$preoderVal= Yii::app()->functions->getOption("merchant_preorder",$merchant_id);
        ...
        <?php }?>
	         ...
	         ?>
	         <?php $_SESSION['kr_delivery_options']['delivery_asap']= 1;?>
	         	<div class="icheckbox_minimal checked" style="position: relative;"><input class="icheck" type="checkbox" name="delivery_asap" id="delivery_asap" style="position: absolute; opacity: 0;" value="2"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div>
	            <span class="text-muted"><?php echo Yii::t("default","Delivery ASAP?")?></span>	          
	         </span>
	         	<!-- <script type="text/javascript">
	         		document.getElementById("delivery_asap").disabled = true;
	         		document.getElementById("delivery_asap").checked = true;
	         	</script> -->
	         <?php }       	         	        	     
	         endif;?>    
